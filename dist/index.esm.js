...
var VChipRound$1 = React.memo(VChipRound, function (prev, next) { return prev.isDark === next.isDark; });
...
var VXCPrice = function (_a) {
    ...
    return vxcPriceUsd ? (React.createElement(PriceLink$2, { href: "http://localhost:3000/swap?outputCurrency=0xdA94C8c31e2B0426CEf30E42964cE4d3aa9B06d3", target: "_blank" },
        ...
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + vxcPriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var vChipPrice = function (_a) {
    ...
    return vchipPriceUsd ? (React.createElement(PriceLink$1, { href: "http://localhost:3000/swap?outputCurrency=0x70eBEfC51cea896b1742DB245a31D96098b5B8E3", target: "_blank" },
        React.createElement(VChipRound$1, { width: "24px", mr: "8px", isDark: isDark }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + vchipPriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var VChipPrice = React.memo(vChipPrice);
...
var BankPrice = function (_a) {
    ...
    return bankPriceUsd ? (React.createElement(PriceLink, { href: "http://localhost:3000/swap?outputCurrency=0xca7F55bC7cD3ee83e69d3F366062D68617115F3c", target: "_blank" },
        ...
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + bankPriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var Menu$1 = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(VXCPrice$1, { vxcPriceUsd: vxcPriceUsd, isDark: isDark }),
            React.createElement(VChipPrice, { vchipPriceUsd: vchipPriceUsd, isDark: isDark }),
