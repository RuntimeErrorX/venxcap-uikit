...
var templateObject_1$1a, templateObject_2$s, templateObject_3$c;
...
var Icon$I = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("img", { width: '32', height: '32', src: imgSrc, srcSet: imgSrc })));
};
...
var VenetianXRoundSml = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    var imgSrc = isDark ? "/images/logo/VenXCapLogoRound.png" : "/images/logo/VenXCapLogoRoundLight.png";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 42 42" }, props),
        React.createElement("image", { width: "40", height: "40", href: imgSrc })));
};
var VenetianXRoundSml$1 = React.memo(VenetianXRoundSml, function (prev, next) { return prev.isDark === next.isDark; });
...
var VChipRound = React.memo(vChipRound, function (prev, next) { return prev.isDark === next.isDark; });
...
var BankRound$1 = React.memo(BankRound, function (prev, next) { return prev.isDark === next.isDark; });
...
var IconModule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AddIcon: Icon$1x,
    ArrowBackIcon: Icon$1w,
    ArrowDownIcon: Icon$1v,
    ArrowDropDownIcon: Icon$1u,
    ArrowDropUpIcon: Icon$1t,
    ArrowFirstIcon: Icon$1s,
    ArrowForwardIcon: Icon$1r,
    ArrowLastIcon: Icon$1q,
    ArrowUpIcon: Icon$1p,
    AutoRenewIcon: Icon$1o,
    BinanceIcon: Icon$1n,
    BinanceChainIcon: Icon$1m,
    BlockIcon: Icon$1z,
    BnbUsdtPairTokenIcon: Icon$1l,
    BunnyCardsIcon: Icon$1k,
    BunnyPlaceholderIcon: Icon$1j,
    Cards: Icon$1i,
    CardViewIcon: Icon$1h,
    CalculateIcon: Icon$1g,
    CircleOutlineIcon: Icon$1f,
    ChartIcon: Icon$1e,
    CheckmarkIcon: Icon$1d,
    CheckmarkCircleIcon: Icon$1B,
    CheckmarkCircleFillIcon: Icon$1c,
    ChevronDownIcon: Icon$1b,
    ChevronLeftIcon: Icon$1a,
    ChevronRightIcon: Icon$19,
    ChevronUpIcon: Icon$18,
    CloseIcon: Icon$17,
    CogIcon: Icon$16,
    Coin98Icon: Icon$15,
    CommunityIcon: Icon$14,
    CopyIcon: Icon$13,
    CrownIcon: Icon$12,
    ErrorIcon: Icon$1A,
    EllipsisIcon: Icon$11,
    HelpIcon: Icon$10,
    HistoryIcon: Icon$$,
    InfoIcon: Icon$1y,
    LanguageIcon: Icon$_,
    LaurelLeftIcon: Icon$Z,
    LaurelRightIcon: Icon$Y,
    ListViewIcon: Icon$X,
    LoginIcon: Icon$W,
    LogoIcon: Icon$V,
    LogoRoundIcon: Icon$U,
    MathWalletIcon: Icon$T,
    LogoutIcon: Icon$S,
    MedalBronzeIcon: Icon$R,
    MedalGoldIcon: Icon$Q,
    MedalPurpleIcon: Icon$P,
    MedalSilverIcon: Icon$O,
    MedalTealIcon: Icon$N,
    MetamaskIcon: Icon$M,
    MinusIcon: Icon$L,
    MoreHorizontalIcon: Icon$K,
    MoreVerticalIcon: Icon$J,
    NoProfileAvatarIcon: Icon$I,
    OpenNewIcon: Icon$H,
    PancakesIcon: Icon$G,
    PencilIcon: Icon$F,
    PancakeRoundIcon: Icon$E,
    VenetianXRound: VenetianXRound$1,
    VenetianXRoundSml: VenetianXRoundSml$1,
    VChipRound: VChipRound,
    BankRound: BankRound$1,
    PocketWatchIcon: Icon$D,
    PlayCircleOutlineIcon: Icon$C,
    ...
    TestnetIcon: Icon$i,
    Ticket: Icon$h,
    TicketFillIcon: Icon$g,
    TicketRound: Icon$f,
    TimerIcon: Icon$e,
    TokenPocketIcon: Icon$d,
    TrophyGoldIcon: Icon$c,
    TrustWalletIcon: Icon$b,
    TuneIcon: Icon$a,
...
var Flex$1 = styled(Box)(templateObject_1$14 || (templateObject_1$14 = __makeTemplateObject(["\n  display: flex;\n  ", "\n"], ["\n  display: flex;\n  ", "\n"])), flexbox);
...
var templateObject_1$13, templateObject_2$r, templateObject_3$b, templateObject_4$8;
...
var StyledBalanceInput = styled(Box)(templateObject_1$11 || (templateObject_1$11 = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var BalanceInput = function (_a) {
    var value = _a.value, _b = _a.placeholder, placeholder = _b === void 0 ? "0.0" : _b, onUserInput = _a.onUserInput, currencyValue = _a.currencyValue, inputProps = _a.inputProps, innerRef = _a.innerRef, _c = _a.isWarning, isWarning = _c === void 0 ? false : _c, _d = _a.decimals, decimals = _d === void 0 ? 18 : _d; _a.unit; _a.switchEditingUnits; var props = __rest(_a, ["value", "placeholder", "onUserInput", "currencyValue", "inputProps", "innerRef", "isWarning", "decimals", "unit", "switchEditingUnits"]);
...
var StyledBackgroundImage = styled(Wrapper$3)(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  background-repeat: no-repeat;\n  background-size: contain;\n"], ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"])));
...
var StyledLink = styled(Text)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
var Link = function (_a) {
    var external = _a.external; __rest(_a, ["external"]);
    var internalProps = external ? getExternalLinkProps() : {};
    return React.createElement(StyledLink, __assign({ as: "a", bold: true }, internalProps));
};
Link.defaultProps = {
    color: "primary",
};
...
var templateObject_1$E, templateObject_2$j, templateObject_3$a;
...
var templateObject_1$A, templateObject_2$h, templateObject_3$9, templateObject_4$7, templateObject_5$6, templateObject_6$3, templateObject_7$2;
...
var templateObject_1$z, templateObject_2$g, templateObject_3$8, templateObject_4$6, templateObject_5$5;
...
var float1 = keyframes(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-75%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-75%);\n\t}\n"])));
var float = keyframes(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatex(0px);\n\t\ttransform: translatey(-40px);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatex(0px);\n\t\ttransform: translatey(-40px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatex(0px);\n\t\ttransform: translatey(-40px);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatex(0px);\n\t\ttransform: translatey(-40px);\n\t}\n"])));
var float2 = keyframes(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n"])));
var Container = styled.div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
styled(VenetianXIcon)(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n  position: absolute;\n  padding-top: 1%;\n  margin: auto 0px;\n  text-align:center;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  padding-top: 1%;\n  margin: auto 0px;\n  text-align:center;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var templateObject_1$y, templateObject_2$f, templateObject_3$7, templateObject_4$5, templateObject_5$4, templateObject_6$2, templateObject_7$1, templateObject_8, templateObject_9;
...
var StyledStep = styled(Flex$1)(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  ", " {\n    justify-content: center;\n  }\n"], ["\n  ", " {\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var templateObject_1$w, templateObject_2$e, templateObject_3$6, templateObject_4$4, templateObject_5$3, templateObject_6$1, templateObject_7;
...
var Wrapper$1 = styled(Flex$1)(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
var Inner$1 = styled(Flex$1)(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  justify-content: space-between;\n  flex-grow: 1;\n\n  & > button + button {\n    margin-left: 4px;\n  }\n\n  ", " {\n    flex-grow: 0;\n  }\n"], ["\n  justify-content: space-between;\n  flex-grow: 1;\n\n  & > button + button {\n    margin-left: 4px;\n  }\n\n  ", " {\n    flex-grow: 0;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var Tab = styled.button(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"])), getPadding, getBorderRadius, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, color);
Tab.defaultProps = {
...
var templateObject_1$s, templateObject_2$c, templateObject_3$5;
    ...
    return (React.createElement(StyledToggle, { "$checked": isChecked, "$checkedColor": checkedColor, "$defaultColor": defaultColor, scale: scale },
        ...
        startIcon && endIcon ? (React.createElement(React.Fragment, null,
            React.createElement(Handle, { scale: scale },
                React.createElement(Flex$1, { height: "100%", alignItems: "center", justifyContent: "center" }, checked ? endIcon(checked) : startIcon(!checked))),
            React.createElement(Flex$1, { width: "100%", height: "100%", justifyContent: "space-around", alignItems: "center" },
                startIcon(),
...
var ModalTitle = styled(Flex$1)(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  align-items: center;\n  flex: 1;\n"], ["\n  align-items: center;\n  flex: 1;\n"])));
...
var templateObject_1$q, templateObject_2$a, templateObject_3$4, templateObject_4$3;
...
var StyledBottomNavItem$1 = styled.button(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 16px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"], ["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 16px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var DropdownMenuItem = styled.button(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"], ["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"])), function (_a) {
...
var templateObject_1$l, templateObject_2$7, templateObject_3$3, templateObject_4$2, templateObject_5$2;
...
var Flex = styled.div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  display: flex;\n  ", "\n  ", "\n"], ["\n  display: flex;\n  ", "\n  ", "\n"])), flexbox, space);
var templateObject_1$k;
...
var SocialLinks = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Flex$1, __assign({}, props), socials.map(function (social, index) {
        var iconProps = {
...
var StyledToolsContainer = styled(Flex$1)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  border-color: ", ";\n  border-top-width: 1px;\n  border-bottom-width: 1px;\n  border-style: solid;\n  padding: 24px 0;\n  margin-bottom: 24px;\n\n  ", " {\n    border-top-width: 0;\n    border-bottom-width: 0;\n    padding: 0 0;\n    margin-bottom: 0;\n  }\n"], ["\n  border-color: ", ";\n  border-top-width: 1px;\n  border-bottom-width: 1px;\n  border-style: solid;\n  padding: 24px 0;\n  margin-bottom: 24px;\n\n  ", " {\n    border-top-width: 0;\n    border-bottom-width: 0;\n    padding: 0 0;\n    margin-bottom: 0;\n  }\n"])), darkColors.cardBorder, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var StyledSocialLinks = styled(SocialLinks$1)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  border-bottom: 1px solid ", ";\n"], ["\n  border-bottom: 1px solid ", ";\n"])), darkColors.cardBorder);
var templateObject_1$j, templateObject_2$6, templateObject_3$2, templateObject_4$1, templateObject_5$1, templateObject_6;
...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Dropdown, { position: dropdownPosition, target: React.createElement(Button, { scale: buttonScale, variant: "text", startIcon: React.createElement(Icon$_, { color: color, width: "24px" }) }, !hideLanguage && React.createElement(Text, { color: color }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.locale, fullWidth: true, onClick: function () { return setLang(lang); }, 
        // Safari fix
        style: { minHeight: "32px", height: "auto" } }, lang.language)); })));
};
var LangSelector$1 = React.memo(LangSelector, function (prev, next) { return prev.currentLang === next.currentLang; });

var PriceLink$5 = styled.a(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var VXCPrice$2 = function (_a) {
    var vxcPriceUsd = _a.vxcPriceUsd, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    var theme = useTheme();
    return vxcPriceUsd ? (React.createElement(PriceLink$5, { href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React.createElement(VenetianXRound$1, { width: "24px", mr: "8px", isDark: theme.isDark }),
        React.createElement(Text, { color: color, bold: true }, "$" + vxcPriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var VXCPrice$3 = React.memo(VXCPrice$2);
var templateObject_1$h;

var PriceLink$4 = styled.a(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var VChipPrice$2 = function (_a) {
...
var PriceLink$3 = styled.a(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var BankPrice$2 = function (_a) {
    var bankPriceUsd = _a.bankPriceUsd, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    var theme = useTheme();
                    ...
                    return (React.createElement(StyledList, { key: item.label },
                        ...
                        _a.map(function (_a) {
                            ...
                            return (React.createElement(StyledListItem, { key: label },
                                React.createElement(Link, { href: href, target: "_black", color: isHighlighted ? baseColors.warning : darkColors.text, bold: false }, label)));
                        })));
                }),
...
var StyledMenuItem = styled.a(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n\n  color: ", ";\n  font-size: 16px;\n  font-weight: ", ";\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background: ", ";\n    ", ";\n  }\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n\n  color: ", ";\n  font-size: 16px;\n  font-weight: ", ";\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background: ", ";\n    ", ";\n  }\n"])), function (_a) {
...
var StyledSubMenuItems = styled(Flex$1)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"], ["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var PriceLink$2 = styled.a(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var VXCPrice = function (_a) {
    var vxcPriceUsd = _a.vxcPriceUsd, isDark = _a.isDark;
    return vxcPriceUsd ? (React.createElement(PriceLink$2, { href: "http://localhost:3000/swap?outputCurrency=0xdA94C8c31e2B0426CEf30E42964cE4d3aa9B06d3", target: "_blank" },
...
var VXCPrice$1 = React.memo(VXCPrice);
var templateObject_1$c;

var PriceLink$1 = styled.a(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var VChipPrice = function (_a) {
    var vchipPriceUsd = _a.vchipPriceUsd, isDark = _a.isDark;
    return vchipPriceUsd ? (React.createElement(PriceLink$1, { href: "http://localhost:3000/swap?outputCurrency=0x70eBEfC51cea896b1742DB245a31D96098b5B8E3", target: "_blank" },
        React.createElement(VChipRound, { width: "24px", mr: "8px", isDark: isDark }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + vchipPriceUsd.toFixed(10)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var VChipPrice$1 = React.memo(VChipPrice);
var templateObject_1$b;
...
var BankPrice = function (_a) {
    ...
    return bankPriceUsd ? (React.createElement(PriceLink, { href: "http://localhost:3000/swap?outputCurrency=0xca7F55bC7cD3ee83e69d3F366062D68617115F3c", target: "_blank" },
        React.createElement(BankRound$1, { width: "24px", mr: "8px", isDark: isDark }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + bankPriceUsd.toFixed(10)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var BankPrice$1 = React.memo(BankPrice);
...
var MoreWalletCard = function (props) {
    return (React.createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React.createElement(Icon$K, { width: "40px", mb: "8px", color: "textSubtle" }),
...
var Menu$1 = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, currentLang = _a.currentLang, setLang = _a.setLang, vxcPriceUsd = _a.vxcPriceUsd, vchipPriceUsd = _a.vchipPriceUsd, bankPriceUsd = _a.bankPriceUsd, 
    // spotLightPriceUsd,
    links = _a.links, subLinks = _a.subLinks, footerLinks = _a.footerLinks, activeItem = _a.activeItem, activeSubItem = _a.activeSubItem, langs = _a.langs, buyVXCLabel = _a.buyVXCLabel, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Flex, null,
                React.createElement(Logo$1, { isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/", width: '171px' }),
            ...
            React.createElement(Flex, { alignItems: "center" },
                !isMobile && (React.createElement(React.Fragment, null,
                    React.createElement(Box, { mr: "36px" },
                        React.createElement(VXCPrice$1, { vxcPriceUsd: vxcPriceUsd, isDark: theme.isDark })),
                    React.createElement(Box, { mr: "36px" },
                        React.createElement(VChipPrice$1, { vchipPriceUsd: vchipPriceUsd, isDark: theme.isDark })),
                    React.createElement(Box, { mr: "36px" },
                        React.createElement(BankPrice$1, { bankPriceUsd: bankPriceUsd, isDark: theme.isDark })))),
...
var NoProfileMenuIcon = function () { return (React.createElement(MenuIconWrapper, { borderColor: "primary" },
    React.createElement(Icon$1, { color: "primary", width: "24px" }))); };
...
var WarningMenuIcon = function () { return (React.createElement(MenuIconWrapper, { borderColor: "warning" },
    React.createElement(Icon$4, { color: "warning", width: "24px" }))); };
var DangerMenuIcon = function () { return (React.createElement(MenuIconWrapper, { borderColor: "failure" },
    React.createElement(Icon$4, { color: "failure", width: "24px" }))); };
...
var UserMenu = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React.createElement(Icon$1b, { color: "text", width: "24px" })),
...
export { Icon$1x as AddIcon, Alert, Icon$1w as ArrowBackIcon, Icon$1v as ArrowDownIcon, Icon$1u as ArrowDropDownIcon, Icon$1t as ArrowDropUpIcon, Icon$1s as ArrowFirstIcon, Icon$1r as ArrowForwardIcon, Icon$1q as ArrowLastIcon, Icon$1p as ArrowUpIcon, Icon$1o as AutoRenewIcon, BackgroundImage, BalanceInput, BankRound$1 as BankRound, GridLayout$1 as BaseLayout, Icon$1m as BinanceChainIcon, Icon$1n as BinanceIcon, Icon$1z as BlockIcon, Icon$1l as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1k as BunnyCardsIcon, Icon$1j as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1g as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1h as CardViewIcon, Icon$1i as Cards, GridLayout as CardsLayout, Icon$1e as ChartIcon, Checkbox, Icon$1c as CheckmarkCircleFillIcon, Icon$1B as CheckmarkCircleIcon, Icon$1d as CheckmarkIcon, Icon$1b as ChevronDownIcon, Icon$1a as ChevronLeftIcon, Icon$19 as ChevronRightIcon, Icon$18 as ChevronUpIcon, Icon$1f as CircleOutlineIcon, Icon$17 as CloseIcon, Icon$16 as CogIcon, Icon$15 as Coin98Icon, Icon$14 as CommunityIcon, ConnectorNames, Icon$13 as CopyIcon, Icon$12 as CrownIcon, Dropdown, Icon$11 as EllipsisIcon, Icon$1A as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex$1 as Flex, Grid, Heading, Icon$10 as HelpIcon, Icon$$ as HistoryIcon, IconButton, Image, Icon$1y as InfoIcon, Input$1 as Input, Icon$_ as LanguageIcon, Icon$Z as LaurelLeftIcon, Icon$Y as LaurelRightIcon, Link, LinkExternal, Icon$X as ListViewIcon, Icon$W as LoginIcon, Icon$V as LogoIcon, Icon$U as LogoRoundIcon, Icon$S as LogoutIcon, Icon$T as MathWalletIcon, Icon$R as MedalBronzeIcon, Icon$Q as MedalGoldIcon, Icon$P as MedalPurpleIcon, Icon$O as MedalSilverIcon, Icon$N as MedalTealIcon, Menu$1 as Menu, Message, Icon$M as MetamaskIcon, Icon$L as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$K as MoreHorizontalIcon, Icon$J as MoreVerticalIcon, Icon$I as NoProfileAvatarIcon, NotificationDot, Icon$H as OpenNewIcon, Overlay, Icon$E as PancakeRoundIcon, PancakeToggle, Icon$G as PancakesIcon, Icon$F as PencilIcon, Icon$C as PlayCircleOutlineIcon, Icon$D as PocketWatchIcon, Icon$B as PredictionsIcon, Icon$v as PresentCheckIcon, Icon$t as PresentNoneIcon, Icon$u as PresentWonIcon, Icon$A as PrizeIcon, Progress, Icon$w as ProgressBunny, Icon$z as ProposalIcon, Radio, Icon$s as RefreshIcon, Icon$y as RemoveIcon, ResetCSS, Icon$r as SafePalIcon, Icon$q as SearchIcon, Skeleton, Slider, Icon$p as SmallDotIcon, Spinner, Icon$o as StarFillIcon, Icon$n as StarLineIcon, Step, Stepper, Svg, Icon$m as SwapIcon, Icon$l as SwapVertIcon, Icon$k as SyncAltIcon, Tab, ButtonMenu as TabMenu, Tag, Icon$j as TeamPlayerIcon, Icon$i as TestnetIcon, Text, Icon$h as Ticket, Icon$g as TicketFillIcon, Icon$f as TicketRound, Icon$e as TimerIcon, ToastContainer, Toggle, TokenImage, TokenPairImage, Icon$d as TokenPocketIcon, TooltipText, Icon$c as TrophyGoldIcon, Icon$b as TrustWalletIcon, Icon$a as TuneIcon, UserMenu, UserMenuDivider, UserMenuItem, VChipRound, VenetianXRound$1 as VenetianXRound, VenetianXRoundSml$1 as VenetianXRoundSml, Icon$x as VerifiedIcon, Icon$9 as VisibilityOff, Icon$8 as VisibilityOn, Icon$7 as VolumeOffIcon, Icon$6 as VolumeUpIcon, Icon$5 as VoteIcon, Icon as WaitIcon, Icon$3 as WalletConnectIcon, Icon$1 as WalletFilledIcon, Icon$2 as WalletIcon, Icon$4 as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal, useWalletModalV1 };
