...
var float2 = styled.keyframes(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-60%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-60%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-60%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(-60%);\n\t}\n"])));
var float = styled.keyframes(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(0px);\n\t}\n\t50% {\n\t\ttransform: translatex(-45%);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(45%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(0px);\n\t}\n\t50% {\n\t\ttransform: translatex(-45%);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(45%);\n\t}\n"])));
var float1 = styled.keyframes(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(70%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(70%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(70%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(70%);\n\t}\n"])));
